...
public class PantallaGanasteMoneda extends BaseScreen {
    ...
    public PantallaGanasteMoneda(Principal principal,long monedas) {
        super(null);
        ...
        continuarButton.addListener(new ClickListener() {
            ...
            public void clicked(InputEvent event, float x, float y) {
                ...
                principal.setScreen(new MenuJuegosScreen(principal)); // Puedes reemplazar con la pantalla que quieras
            }
        });
